...
Scenario Outline: Employee Editor Create Application
  ...
  Examples: 
   ...
   | employee| QACE    | eGov@123  | City A |Residential|Independent house|143001   |Main Road Abadpura|K.K sahi |Conventional septic tank|Mahindra - Bolero Pickup - 1000 Ltrs|
...
Scenario Outline: CE Explore Filter
 ...
 Examples: 
   ...
   | employee| UATCC    | eGov@123  | City A  |9869313101 |PB-PGR-2021-08-20-002211|
