...
@fsm10
Scenario Outline: Employee Editor Creator Collector and Editor Flow
  ...
  Examples: 
   ...
   | employee| UATCEC  | eGov@123  | City A|Institutional|Temple |143001 |Main Road Abadpura|K.K sahi|Conventional septic tank|Mahindra - Bolero Pickup - 1000 Ltrs|
...
Examples: 
   ...
   |employee|QAADMIN  | eGov@123  | City A | Duplicate Application|Pending for DSO Approval     |
