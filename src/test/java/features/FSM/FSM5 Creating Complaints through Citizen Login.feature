...
Examples: 
   ...
   | citizen| 9869313101 | 123456 | Commercial | Hotel  |  K.K sahi | 143001  | 400013   |
...
Scenario Outline: Explore Employee Inbox- Search Application
  ...
  And Employee Logout and Close
   ...
   | employee| QAEE    | eGov@123  | City A | Commercial | Hotel   |143003 |Preet Nagar|Gangadhar Sahi|Septic tank with soak pit|Tata - 407 - 3000 Ltrs|Hotel    |
...
Scenario Outline: Editor Re-Assign Application To DSO
  ...
  Examples: 
   ...
   | employee|QAEE     | eGov@123  | City A|Vehicle is under repair|
...
Scenario Outline: FSTPO Vehicle 
  ...
  Examples: 
   | url     |Username | Password  | City   |
   | employee|QAFSTPO  | eGov@123  | City A | 
