...
Scenario Outline: Employee Editor Create Application
  ...
  Examples: 
   ...
   | employee| QACE    | eGov@123  | City A|Commercial|Hotel  |143003 |Preet Nagar|Gangadhar Sahi|Conventional septic tank|Mahindra - Bolero Pickup - 1000 Ltrs|
...
Scenario Outline: Editor Re Re-Assign Application To DSO
  ...
  Examples: 
   | url     |Username | Password   | City  |Reason           |
   | employee|QAEE     | eGov@123   | City A|Inaccessible road|
