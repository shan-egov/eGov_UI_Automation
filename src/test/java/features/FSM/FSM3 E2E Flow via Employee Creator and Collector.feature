...
Scenario Outline: Employee Editor Create Application and Collector Collect
  ...
  Examples: 
   ...
   | employee| UATCC   | eGov@123  | City A|Residential|Independent house|143001 |Main Road Abadpura|K.K sahi |Conventional septic tank|Mahindra - Bolero Pickup - 1000 Ltrs|
